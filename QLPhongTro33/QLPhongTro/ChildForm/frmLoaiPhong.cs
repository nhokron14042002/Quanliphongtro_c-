...
namespace QLPhongTro.ChildForm
{
    public partial class frmLoaiPhong : Form
    {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (xacNhan == 1)// thêm mới loại phòng trọ
            {
                prList.Add(new CustomParameter
                {
                    key = "@tenLoaiPhong",
            ...
            if (xacNhan == -1)// trường hợp cập nhật loại phòng trọ
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
                ...
                "Xác nhận xóa", MessageBoxButtons.YesNo, MessageBoxIcon.Question)) == DialogResult.Yes)
            {
                ...
                if (rs == 1)
                {
                    MessageBox.Show("Xóa loại phòng thành công !!!", "Sucsessfully!", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    LoadDsLoaiPhong();
                    maLoaiPhong = 0; // reset ma loại phòng (reset id phòng về giá trị mặc định) 
                }
            }
        }
    }
